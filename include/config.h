...
namespace Config {
    ...
    namespace CommandHandler {
        ...
        constexpr char CMD_INC_RUN_CURRENT  = 'q';
        constexpr char CMD_DEC_RUN_CURRENT  = 'e';
        constexpr char CMD_INC_HOLD_CURRENT = 'a';
        constexpr char CMD_DEC_HOLD_CURRENT = 'd';
        constexpr char CMD_SHOW_CURRENT     = 'c';
        constexpr char CMD_INC_SPEED        = 'r';
        constexpr char CMD_DEC_SPEED        = 'f';
        constexpr char CMD_INC_ACCEL        = 'u';
        constexpr char CMD_DEC_ACCEL        = 'j';
        constexpr char CMD_SHOW_SPEED       = 'v';
